...
<div class="container">
    <div class="table table-responsive">
        ...
        <table class="table table-striped table-hover" style="font-family: Georgia">
        ...
        <table class="table table-striped table-hover" id="locations" style="font-family: Georgia">
                ...
                <c:when test="${recDates != null}">
                    ...
                    <c:forEach var="i" begin="0" end="${datenum}">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="https://maps.google.com?saddr=Current+Location&daddr=${recDates.get(i).location}"
