...
<div class="dateFinder" style="padding-left: 30pt; padding-right: 30pt">
    ...
    <div style="padding: 20pt; align-content: center">
        <div class="col-12 col-sm-12 col-lg-12">
            <div class="table table-responsive" style="font-family: Georgia">
                <c:choose>
                    ...
                    <c:if test="${dates != null}">
                        ...
                        <c:forEach var="i" begin="0" end="${datenum}">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="https://maps.google.com?saddr=Current+Location&daddr=${dates.get(i).location}"
                            ...
                            <c:param name="date" value="${dates.get(i).getId()}"/>
                                    ...
                                    <c:otherwise>
                                        <td><a href="<c:url value="/Home?action=login">
                            </c:url>" title="Must be logged in" disabled><i class="fas fa-clipboard"></i></a></td>
                                    </c:otherwise>
                                </c:choose>
                            </tr>
